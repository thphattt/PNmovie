...
const MovieDetails = () => {
  ...
  return show ? (
    <div className="px-6 md:px-16 lg:px-40 pt-30 md:pt-50">
      <div className="flex flex-col md:flex-row gap-8 max-w-6xl mx-auto">
        ...
        <div className="relative flex flex-col gap-4">
          ...
          <div className="flex items-center gap-4 flex-wrap mt-4">
            ...
            <button className="bg-gray-700 p-2.5 rounded-full hover:bg-primary transition active:scale-95 cursor-pointer">
      ...
      <p className="text-lg font-medium mt-20">Your Favortie Cast</p>
      ...
      <div className="flex items-center flex-wrap max-sm:justify-center gap-8">
