  ...
  return (
    ...
    >
      <Link to={"/"} className="max-md:flex-1">
        <img src={assets.logo} alt="" className="w-36 h-auto text-white" />
      </Link>
      <div
        className={`max-md:absolute max-md:top-0 max-md:left-0 max-md:font-medium
     max-md:text-lg z-50 flex flex-col md:flex-row items-center gap-8 max-md:justify-center 
     min-md:px-8 py-3 max-md:h-screen min-md:rounded-full backdrop-blur bg-black/70 md:bg-white/10 
